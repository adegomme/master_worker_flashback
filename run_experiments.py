...
energy_plugins = {
        ...
        "stable":"--cfg=plugin:host_energy",
        "unstable":"--cfg=plugin:host_energy",
        "unstable_old":"--cfg=plugin:host_energy"
        }
